...
export const HeroSection = () => {
  return (
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,rgba(0,0,0,0.9),rgba(0,0,0,0.9),transparent)]">
        <div
        ...
        <HeroOrbit size={440} rotation={79} shouldOrbit orbitDuration="32s">
          <StarIcon className="size5 text-emerald-300/20" />
        </HeroOrbit>
        ...
        <HeroOrbit size={800} rotation={-72} shouldOrbit orbitDuration="48s" shouldSpin>
      ...
      <div className="container">
        <div className="flex flex-col items-center">
          <Image
            src={memojiImage}
            className="size-[100px] md:size-[110px] lg:size-[130px]"
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          ...
          <a href="mailto:albinjobyponnu@gmail.com" className="z-10">
